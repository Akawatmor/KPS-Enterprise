...
หลังใช้ Woodpecker CI/CD กระบวนการถูกแปลงเป็น flow ที่ชัดเจน 10 Stage ดังนี้
...
| CI/CD | push→ 10 stage pipeline ครบ: quality gates, canary, monitoring, k6, DAST, release tag | initial cluster provisioning ยังเป็น manual |
